...
import {COMPONENT, SIDEBAR_ITEM, ROW, COLUMN} from '../data/constants'
...
const DropZone = ({data, onDrop, isLast, className}) => {
  ...
  return (
    /* classNames('dropZone', {active: isActive, isLast}, className) */
    <div className={['dropZone', isActive ? 'active': '', isLast, className].join(' ')} ref={drop}>
      {/* <Button variant='light-success' size='sm' className='btn-icon'>

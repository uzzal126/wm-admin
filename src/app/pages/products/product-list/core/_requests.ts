...
import {BASE_URL, PRODUCT_STOCK_UPDATE} from '../../../../constants/api.constants'
import {getAuth, setAuth} from '../../../../modules/auth'
import {Product, ProductsQueryResponse, StockModal} from './_models'

const USER_URL = `${BASE_URL}/product`
const GET_PRODUCT = `${BASE_URL}/product`
...
export {createUser, deleteSelectedUsers, deleteUser, getUserById, getUsers, updateStock, updateUser}

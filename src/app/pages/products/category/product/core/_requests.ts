...
import {BASE_URL, POST_CATEGORY_REMOVE_PRODUCT} from '../../../../../constants/api.constants'
...
const GET_PRODUCT = `${BASE_URL}/product/category`
...
const deleteSelectedUsers = (userIds: Array<ID>, catId: any): Promise<void> => {
  const requests = userIds.map((id) =>
    axios({
      method: 'post',
      url: `${POST_CATEGORY_REMOVE_PRODUCT}`,
      data: {
        pd_id: [id],
        cat_id: 1,
      },
...
export {deleteSelectedUsers, getUsers}

...
import {DASHBOARD_TOP_SELLING} from '../../../constants/api.constants'
...
const TopSale = () => {
  ...
  const getData = async () => {
    ...
    const res = await getQueryRequest(DASHBOARD_TOP_SELLING + slug)
    ...
    <div className={clsx('card h-100')}>
      <div className='card-header min-h-auto align-items-center mt-3'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='fw-bolder text-dark fs-3'>Top Selling Products</span>
        </h3>
        <div className='card-toolbar'>
          <Link to={'/reports/inventory/top/sale'}>
            ...
            <div className='row' key={i}>
              ...
              <div className='col-3 pe-0'>
                <div className='text-end py-lg-0 py-2'>
                  ...
                  <span className='text-gray-400 fs-7 fw-bold d-block'>Quantity</span>
                </div>
              </div>
            </div>
          ))

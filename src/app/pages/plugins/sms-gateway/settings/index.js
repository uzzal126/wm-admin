...
import {updateAllUsers} from './core/_requests'
      ...
      <KTCard className='mb-4'>
                ...
                <div className='card card-flush w-lg-650px py-5'>
                  {isLoading ? (
                    ...
                    <div className='card-body py-15 py-lg-20'>
                      ...
                      <div className='mb-0'>
                        <Link to='/plugins/sms-gateway/index' className='btn btn-sm btn-primary'>
                          Go Back
                        </Link>
                      </div>
                    </div>
        ...
        <div className='card-footer'>
          <div className='d-flex align-items-center justify-content-end'>
            <Link to='/plugins/sms-gateway/index' className='btn btn-light me-5'>
              Cancel
            </Link>
            <button
              type='submit'

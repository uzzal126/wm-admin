...
const GET_TEMPLATES = `${BASE_URL}/sms/bundles`
...
const CANCEL_REQUEST = `${BASE_URL}/sms/cancel/bundle-request`
const GET_REPORT_SUMMARY = `${BASE_URL}/sms/balance-report-summary`

...
export const breadcrumbs = (active) => {
    return [
        {
            title: 'Dashboard',
            path: '/marketing/sms-gateway/index',
        ...
        {
            title: 'Send SMS',
            path: '/marketing/sms-gateway/sender',
            activeClasses: "btn-info",
            classes: "btn-light-dark",
            icon: "",
        ...
        {
            title: 'Report',
            path: '/marketing/sms-gateway/report',
            activeClasses: "btn-info",
            classes: "btn-light-dark",
            icon: "",
        ...
        {
            title: 'Balance',
            path: '/marketing/sms-gateway/balance',
            activeClasses: "btn-info",
            classes: "btn-light-dark",
            icon: "",
        ...
        {
            title: 'SMS Settings',
            path: '/marketing/sms-gateway/settings',
            activeClasses: "btn-info",
            classes: "btn-light-dark",
            icon: "",
...
export const IconCard = ({data}) => {
    return <div className="card card-flush bgi-no-repeat bgi-size-cover bgi-position-x-end bgi-position-y-bottom h-xl-100"
        style={{ backgroundColor: data?.color, backgroundImage: `url(${data?.bg})` }}>
        <div className="card-header pt-5 mb-1">
            <div className="d-flex flex-center rounded-circle h-80px w-80px" style={{ border: ' 1px dashed rgba(255, 255, 255, 0.4)', backgroundColor: data?.color }}>
        ...
        <div className="card-body py-2 pt-0 d-flex align-items-end">
            <div className="d-block d-xxl-flex align-items-center">
                <span className="fs-4hx text-white fw-bold me-0 me-xxl-6">{kFormatter(data?.body?.number)}</span>
        ...
        <div className="card-footer py-2" style={{ borderTop: '1px solid rgba(255, 255, 255, 0.3)', background: 'rgba(0, 0, 0, 0.15)' }}>

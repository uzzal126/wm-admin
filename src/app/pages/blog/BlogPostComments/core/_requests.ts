...
const GET_COMMENTS = `${BASE_URL}/appearance/blog/blog-post/comments`
const DELETE_COMMENT = `${BASE_URL}/appearance/blog/blog-post/comments`
...
const getUsers = (slug: any, query: any): Promise<CommentsQueryResponse> => {
  return axios({
    method: 'get',
    url: `${GET_COMMENTS}/${slug}?${query}`,
...
const updateUser = (user: Comment): Promise<Comment | undefined> => {
  return axios

          ...
          <div className='card-toolbar'>
            <div className='theme-action'>
              <div className='d-flex'>
                <a href={'/shop/theme#installed-themes'} className='btn btn-sm btn-success mx-4'>
                  <span>
                    <i className='ms-2 text-white  fas fa-check-circle' />
                    Installed Themes
                  </span>
                </a>
                <a
                ...
                >
                  <span>
                    <i className='ms-2 text-white  fas fa-globe' />
                    Live Demo
                  </span>
                </a>
